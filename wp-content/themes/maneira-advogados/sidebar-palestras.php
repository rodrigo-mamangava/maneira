			...
			<?php if( !is_page() ) { ?>
				<div class="searchbox">   
				    ...
				    <form name="search" role="search" action="<?php echo site_url('/'); ?>" method="get" id="searchform">
				    	...
				    	<input type="hidden" name="post_type" value="palestras" /> <!-- // hidden 'palestras' value -->
				    	<span class="glyphicon glyphicon-search white" id="search-publicacao" onclick="search.submit()" alt="Search"></span>
			  		</form>
			 	</div>
				<!-- <div class="searchbox">
